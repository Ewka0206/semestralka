...
public class TripController {
    ...
    @Operation(
        ...
        description = "Prohledává pole title, location a country. "
                    + "Vrací pouze plavby s volnými místy, seřazené dle data zahájení. "
    ...
    public Page<Trip> search(
            ...
            @Parameter(description = "Počet výsledků na stránku (výchozí 10, max doporučeno 50)")
            @RequestParam(defaultValue = "10") int size) {
        return tripService.search(q, type, PageRequest.of(page, size));
    }
